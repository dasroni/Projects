...
The output file *instructionsOutput.txt* in **src** is then fed to multimedia unit for processing instructions.     
Full Project Report and description can be found in **Project_Report.pdf**.  
